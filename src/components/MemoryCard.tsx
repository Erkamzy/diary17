  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-shadow border border-purple-100">
      ...
      <div className="p-5">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <Avatar>
              ...
              <AvatarFallback>
                console.log(memory.author.name)
        ...
        <h3 className="font-playfair font-semibold text-xl mb-2 text-purple-900">
          {memory.title}
        </h3>
        <p className="text-purple-700 font-quicksand mb-4 line-clamp-3">
          {memory.description}
        </p>
